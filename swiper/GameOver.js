...
GameOver.prototype = {
	...
	create: function(){
		...
		//Add the buttons
		tryAgainB = this.game.add.button(this.game.world.centerX, 6*game.height/10, 'tryAgain', this.tryAgain, this, 2, 1, 0);
		menuB = this.game.add.button(this.game.world.centerX, 8*game.height/10, 'backToMenu', this.startMenu, this, 2, 1, 0);
